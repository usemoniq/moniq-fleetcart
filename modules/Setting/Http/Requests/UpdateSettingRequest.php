...
class UpdateSettingRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'moniq_enabled' => 'required|boolean',
            'translatable.moniq_label' => 'required_if:moniq_enabled,1',
            'translatable.moniq_description' => 'required_if:moniq_enabled,1',
            'moniq_public_key' => 'required_if:moniq_enabled,1',
            'moniq_api_secret' => 'required_if:moniq_enabled,1',
